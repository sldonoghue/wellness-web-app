...
const propTypes = {
  ...
  paragraph: prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.string,
...
class EventSearch extends react__WEBPACK_IMPORTED_MODULE_4__["Component"] {
  constructor(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(this, "handleFilter", event => {
      let {
        eventsFilterCopy
      } = this.state;
